...
/** The Table Source ITCase for {@link SpannerDialect}. */
class SpannerDynamicTableSourceITCase extends JdbcDynamicTableSourceITCase implements SpannerTestBase {
    ...
    protected TableRow createInputTable() {
        return spannerTableRow(
                ...
                field("decimal_col", dbType("NUMERIC"), DataTypes.DECIMAL(10, 4)),
