...
class SpannerDynamicTableSinkITCase extends JdbcDynamicTableSinkITCase implements SpannerTestBase {
    ...
    protected List<Row> testData() {
        // This is probably due to the implementation of the JDBC driver (it uses the Calendar class internally),
    ...
    protected void testReal() throws Exception {
        ...
        assertThat(realOutputTable.selectAllTable(getMetadata())).containsExactly(Row.of("a", 1.0f));
    }
