...
public class SpannerTypeMapper implements JdbcCatalogTypeMapper {
    ...
    private static final String SPANNER_ARRAY_BOOL = "[Ljava.lang.Boolean;"; // Boolean[].class.getName()
    private static final String SPANNER_ARRAY_BYTES = "[[B"; // byte[][].class.getName()
    // private static final String SPANNER_ARRAY_PROTO = "[[B"; // byte[][].class.getName()
    private static final String SPANNER_ARRAY_DATE = "[Ljava.sql.Date;"; // Date[].class.getName()
    private static final String SPANNER_ARRAY_FLOAT32 = "[Ljava.lang.Float;"; // Float[].class.getName()
    private static final String SPANNER_ARRAY_FLOAT64 = "[Ljava.lang.Double;"; // Double[].class.getName()
    private static final String SPANNER_ARRAY_INT64 = "[Ljava.lang.Long;"; // Long[].class.getName()
    // private static final String SPANNER_ARRAY_ENUM = "[Ljava.lang.Long;"; // Long[].class.getName()
    private static final String SPANNER_ARRAY_NUMERIC = "[Ljava.math.BigDecimal;"; // BigDecimal[].class.getName()
    private static final String SPANNER_ARRAY_STRING = "[Ljava.lang.String;"; // String[].class.getName()
    // private static final String SPANNER_ARRAY_JSON = "[Ljava.lang.String;"; // `String[].class.getName()
    private static final String SPANNER_ARRAY_TIMESTAMP = "[Ljava.sql.Timestamp;"; // Timestamp[].class.getName()
    ...
    private DataType getMapping(String spannerType, String spannerClassName, int precision, int scale) {
        switch (spannerType) {
            case SPANNER_BOOL:
            ...
            case SPANNER_PROTO:
                ...
                // https://github.com/googleapis/java-spanner-jdbc/blob/v2.26.0/src/main/java/com/google/cloud/spanner/jdbc/JdbcResultSetMetaData.java#L157
            ...
            case SPANNER_NUMERIC:
                // The precision for the numeric type is 14 and the scale is 15, both of which are fixed values.
                // https://github.com/googleapis/java-spanner-jdbc/blob/v2.26.0/src/main/java/com/google/cloud/spanner/jdbc/JdbcResultSetMetaData.java#L149
                // https://github.com/googleapis/java-spanner-jdbc/blob/v2.26.0/src/main/java/com/google/cloud/spanner/jdbc/JdbcResultSetMetaData.java#L168
                // But the document describes it as follows.
                // The GoogleSQL NUMERIC is an exact numeric data type capable of representing an exact numeric value
    ...
    private DataType getArrayMapping(String spannerClassName, int precision, int scale) {
        switch (spannerClassName) {
            ...
            default:
                throw new UnsupportedOperationException("Unsupported spanner array type: " + spannerClassName);
        }
    }
}
