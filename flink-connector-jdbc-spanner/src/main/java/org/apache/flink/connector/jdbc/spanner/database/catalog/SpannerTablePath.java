 ...
 * Spanner requires the use of fully qualified names to reference a database object in non-default named schema.
 * The schema name is not required for the default schema.
